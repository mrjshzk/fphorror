...
func load_from_save() -> void:
	...
	player.rotation.y = game_save.player_rotation_y
	camera.rotation.x = game_save.camera_rotation_x
...
func write_to_save() -> void:
	...
	game_save.player_rotation_y = player.rotation.y
	game_save.camera_rotation_x = camera.rotation.x
